      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[70px] md:h-[91px]">
            ...
            <Link
              href="/"
              className="flex items-center bg-gray-900/60 hover:bg-gray-900/80 border border-[#222b44] shadow-sm transition-colors duration-200 rounded-md px-2 py-1 md:px-3 md:py-1.5 min-h-[44px] min-w-[140px]"
              style={{ height: 'auto' }}
            >
              <Image
                ...
                style={{ maxWidth: '180px', minWidth: '0', height: 'auto' }}
              />
            </Link>
